...
bool hasMatch(string n1, string n2)
{
    int l1 = n1.length()-1, j,k;
    int l2 = n2.length()-1;
...
int main()
{
    ...
    fri(1, t)
    {
        ...
        n1.erase(remove(n1.begin(), n1.end(), ' '), n1.end());
        n2.erase(remove(n2.begin(), n2.end(), ' '), n2.end());

        cout << "Case " << i << ": ";
        if(hasMatch(n1, n2)) cout << "Yes" << endl;
        else cout << "No" << endl;
    }
    re 0;
}
